...
### 🏆 [**Helpers of Tomorrow**](https://github.com/itsnotkx/Helpers-Of-Tomorrow) — *Champion, SMU Ellipsis Hackathon 2025*
Volunteer management system using ML to predict elderly risk levels and intelligently match volunteers based on proximity, skills, and availability. Built with Next.js, FastAPI, and Supabase.
